...
export default function Contact() {
  ...
  const waUrl = `https://wa.me/${waNumber}?text=${encodeURIComponent(`Halo Dearma, nama saya ${form.name || '...'}, saya ingin menanyakan tentang rental mobil.`)}`
          ...
          <div className={styles.grid}>
            ...
            <div className={styles.info}>
              ...
              <div className={styles.contacts}>
                <a href={`https://wa.me/${waNumber}`} target="_blank" rel="noopener noreferrer" className={`${styles.contactItem} ${styles.wa}`}>
                  ...
                  <div>
                    ...
                    <p>{formatPhone(waNumber)}</p>
                  </div>
                  <span className={styles.arrow}>→</span>
                </a>

                <a href={`tel:+${phoneNumber}`} className={styles.contactItem}>
                  <div className={styles.contactIcon}>
                  ...
                  <div>
                    ...
                    <p>{formatPhone(phoneNumber) || formatPhone(waNumber)}</p>
                  </div>
                  <span className={styles.arrow}>→</span>
                </a>
